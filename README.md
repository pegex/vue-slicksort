...
| `autoScrollParent`           | Boolean                                                 | `true`                                                                                       | If you want, you can set the nearest scrollable parent (autodetected, and will often be `window`) as the scrolling container. When set to `false`, the slicksort element itself will autoscroll if applicable.                                                                                                                                                                                                             |
